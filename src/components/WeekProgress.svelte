	...
	<div class="relative mt-2">
		<div class="grid-cols-2">
			<div class="text-left text-sm text-gray-600">
				...
				{weekProgress.start.toFormat('dd MMMM yyyy')}
				- {weekProgress.end.toFormat('dd MMMM yyyy')}
			</div>
		...
		<p class="textual-info mt-2 text-sm text-gray-600">
			{weekProgress.passedDays}
			d, {weekProgress.remainingDays}
			d remaining ({weekProgress.passedHours}/{weekProgress.remainingHours}
			h)
		</p>
	</div>
</div>
