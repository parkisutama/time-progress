	...
	<div class="relative mt-2">
		<div class="grid-cols-2">
			<div class="text-left text-sm text-gray-600">
				{monthProgress.start.toFormat('dd MMMM yyyy')}
				-
				{monthProgress.end.toFormat('dd MMMM yyyy')}
			</div>
		...
		<p class="textual-info mt-2 text-sm text-gray-600">
			{monthProgress.passedDays}
			d, {monthProgress.remainingDays} d remaining ({monthProgress.passedHours}/{monthProgress.remainingHours}
			h)
		</p>
	</div>
</div>
